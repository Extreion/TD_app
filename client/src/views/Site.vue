  ...
  <v-container>
    ...
    >
      <v-toolbar dense :color="gateway.status == 'open' ? 'green lighten-1' : 'red lighten-1'">
        ...
        <v-btn icon :to="'/site/gateway/'.concat(gateway._id)" height="35px">
                ...
                <v-card shaped height="100px">
                  <v-toolbar dense color="#FFFAC0" height="25px">
                    ...
                    <v-btn
                      ...
                      :to="'/site/gateway/counter/'.concat(counter.gatewayId, '/' ,counter._id)"
                      height="25px"
                    >
              ...
              <v-container>
                <v-list dense two-line>
                  <v-list-item-group active-class="blue--text">
                    ...
                    <v-list-item>
                      <v-list-item-content>
                        <v-list-item-title>Période de rafrâichissement en Ms</v-list-item-title>
                        <v-list-item-subtitle
                          class="text--primary"
